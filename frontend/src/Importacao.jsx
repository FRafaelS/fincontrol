...
const COLUNAS_MODELO = [
  ...
  { header: 'PARCELA', exemplo: '01 DE 01', dica: 'Use 01 DE 12 para o sistema calcular o valor mensal' },
  ...
  { header: 'VALOR_TOTAL', exemplo: 250.9, dica: 'Valor cheio da compra; em parcelados, será convertido pelo campo PARCELA' },
...
function Importacao({ onVoltar, token, grupos = [], grupoPadraoId = '' }) {
  ...
  const exportarModelo = () => {
    ...
    const wsInstrucoes = XLSX.utils.aoa_to_sheet([
      ...
      ['PARCELA', 'Opcional', 'Exemplo: 02 DE 10. O sistema usa o total de parcelas para calcular o valor do mês.'],
      ...
      ['VALOR_TOTAL', 'Obrigatório', 'Use número sem R$, exemplo: 250.90. Para compras parceladas, informe o valor cheio da compra.'],
